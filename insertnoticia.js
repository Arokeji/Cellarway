/*
 +-------------------------------------------------------------------+
 |                 J S - R I C H E D I T   (v1.19)                   |
 |                                                                   |
 | Copyright Gerd Tentler               www.gerd-tentler.de/tools    |
 | Created: Jun. 2, 2003                Last modified: Nov. 17, 2007 |
 +-------------------------------------------------------------------+
...
// Language settings
//---------------------------------------------------------------------------------------------------------
  var txtParagraph       = "Parrafo";
  var txtNormal          = "Normal";
  var txtHeading         = "Cabecera";
  var txtClearFormatting = "Limpiar formato";
  var txtJustifyLeft     = "Justificar izquierda";
  var txtJustifyCenter   = "Justificar centro";
  var txtJustifyRight    = "Justificar derecha";
  var txtJustifyFull     = "Justificar completo";
  var txtOrderedList     = "Lista ordenada";
  var txtUnorderedList   = "Lista desordenada";
  var txtOutdent         = "Outdent";
  var txtIndent          = "Indent";
  var txtInsertHR        = "Insertar Regla Horizontal";
  var txtInsertTable     = "Insertar Tabla";
  var txtInsertGraph     = "Insertar Grafico";
  var txtInsertBullet    = "Insertar Bullet Point";
  var txtInsertImage     = "Insertar imagen";
  var txtInsertText      = "Insertar texto aqui";
  var txtFont            = "Fuente";
  var txtSize            = "Tamaño";
  var txtBold            = "Negrita";
  var txtItalic          = "Italica";
  var txtUnderline       = "Subrayado";
  var txtFontColor       = "Color de fuente";
  var txtBGColor         = "Color de fondo";
  var txtHyperlink       = "Hyperlink";
  var txtCut             = "Cortar";
  var txtCopy            = "Copiar";
  var txtPaste           = "Pegar";
  var txtUndo            = "Deshacer";
  var txtRedo            = "Rehacer";
  var txtBorder          = "Borde";
  var txtBorderColor     = "Color del borde";
  var txtCellColor       = "Color celda";
  var txtCellSpacing     = "Cell Spacing";
  var txtCellPadding     = "Cell Padding";
  var txtColumns         = "Columnas";
  var txtRows            = "Filas";
  var txtCreate          = "Crear";
  var txtCancel          = "Cancelar";
  var txtValues          = "Valores";
  var txtLabels          = "Etiquetas";
  var txtBarColor        = "Color de la barra";
  var txtLabelColor      = "Color de etiqueta";
  var txtViewValues      = "Ver valores";
  var txtLegend          = "Leyenda";
  var txtViewSource      = "Ver código";
  var txtViewEditor      = "Ver editor";
...
//---------------------------------------------------------------------------------------------------------
  ...
  this.textHeight = 500;                        // text field height (pixels)
...
//---------------------------------------------------------------------------------------------------------
  ...
  this.createImage = function() {
    ...
    if(f.URL.value && f.URL.value != 'http://') {
      if(this.curSelection) this.doCmd('insertHTML', '<div style="float: right; margin-left: 10px; margin-right: 10px;"><IMG src="' + f.URL.value + '"></div>');
      else this.doCmd('insertHTML', '<div style="float: right; margin-left: 10px; margin-right: 10px;"><IMG src="' + f.URL.value + '"></div>');
    }
  }
  ...
  this.buildEditor = function() {
	...
	document.writeln('Titular:<br />');
	
	document.writeln('<input name="titular" type="text" size="73" maxlength="200" />');
	...
	document.writeln('<p align="center"><input type=submit value="Enviar" onClick="rtoStore()"></p>');
